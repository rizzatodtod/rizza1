...
img_How_to_Overcome = Image.open(os.path.join(current_dir, "images", "yt_How_to_Overcome.png"))
img_Common_Problems = Image.open(os.path.join(current_dir, "images", "yt_Common_Problems.png"))
